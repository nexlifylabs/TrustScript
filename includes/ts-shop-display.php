...
class TrustScript_Shop_Display {
	...
	/**
	 * Get the average rating and total review count for a product, combining standard
	 * WooCommerce ratings and TrustScript-only ratings. Results are cached for performance.
	 *
	...
	private function get_product_rating_data( $product_id ) {
		...
		$cache_key   = 'trustscript_shop_rating_' . $product_id;
