<?php
/**
 * Handles rendering the consent checkbox on the WooCommerce checkout page and enqueuing related scripts.
 *
 * @package TrustScript
 * @since 1.0.0
 */
...
class TrustScript_Checkout_Consent {
	...
	/**
	 * Get the current billing country from the checkout form or customer session.
	 *
	 * @since 1.0.0
	...
	/**
	 * Get all countries requiring any form of opt-in consent.
	 *
	 * @since 1.0.0
