...
class TrustScript_Elementor {
	...
	public function register_editor_panel_script() {
		wp_register_script(
			...
			TRUSTSCRIPT_PLUGIN_URL . 'assets/js/marquee-editor-panel.js',
	...
	public function enqueue_widget_styles() {
		...
		if ( $should_enqueue ) {
			wp_enqueue_style(
				...
				TRUSTSCRIPT_PLUGIN_URL . 'assets/css/elementor-widgets.css',
				array(),
				TRUSTSCRIPT_VERSION
			);
		}
	...
	public function register_marquee_assets() {
		wp_register_style(
			...
			TRUSTSCRIPT_PLUGIN_URL . 'assets/css/marquee-slider.css',
			array(),
			TRUSTSCRIPT_VERSION
		);

		wp_register_style(
			'trustscript-elementor-widget',
			false,
			array(),
			TRUSTSCRIPT_VERSION
		);
		...
		wp_register_script(
			'trustscript-marquee-slider',
			TRUSTSCRIPT_PLUGIN_URL . 'assets/js/marquee-slider.js',
