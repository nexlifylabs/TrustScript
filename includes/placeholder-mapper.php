...
class TrustScript_Placeholder_Mapper {
	...
	/**
	 * Builds an array of products formatted for email templates, including safe image URLs.
	 *
	...
	/**
	 * Determines whether to include the physical address in the email based on the
	 * customer's country and plugin settings, and retrieves the address if needed.
	 *
